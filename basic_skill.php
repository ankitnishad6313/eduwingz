...
<div class="section page-banner-section" style="background-image: url(assets/images/bg/page-banner.jpg);">
    ...
    <div class="container">
        ...
        <div class="course-details-banner-content">
            ...
            <h2 class="title">Basic Skills</h2>
        ...
        <div class="row justify-content-between">
            <div class="col-12 col-lg-4">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <?php
                    include ('code/db.php');
                    $tb = "SELECT * FROM `custom_pages` WHERE `pagename` = 'Basic Skills'";
                    $i = 1;
                    ...
                    while ($data = mysqli_fetch_assoc($qry)) {
                        ...
                        <button class="nav-link <?= ($i == 1) ? "active" : "" ?>" id="page-section-tab<?= $data['id'] ?>"
                            ...
                            aria-controls="page-section<?= $data['id'] ?>"
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    while ($data1 = mysqli_fetch_assoc($qry)) {
                        ...
                        <div class="tab-pane fade <?= ($i == 1) ? "show active" : "" ?>"
                            id="page-section<?= $data1['id'] ?>" role="tabpanel"
                            aria-labelledby="page-section-tab<?= $data1['id'] ?>" tabindex="0">
                            <?php
